...
<body>
        ...
        <div class="d-flex justify-content-between px-5 py-2">
            ...
            <main>
                <div id="form-container">
                    <div id="form-box" class="d-flex flex-row main-banner text-warning position-absolute start-50 translate-middle mt-5">
                        <!-- form login -->
    ...
    <!-- place footer here -->
    <footer class="site-footer fixed-bottom col-12">
        <div class="container">
            <div class="row">
                <div class="col-12">
