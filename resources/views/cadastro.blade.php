...
<head>
  <title>Surf-trip-motorista</title>
  <!-- Required meta tags -->
  <meta charset="utf-8">
...
<body>
  <header>
    <!-- place navbar here -->
    <div class="nav d-flex px-5 py-2">
    ...
    <section class="container column">
      <form action="">
        ...
        <div class="mb-3  text-warning">
          ...
          <input type="text" class="form-control" name="cpf" id="" placeholder="Digite seu CPF">
        </div>
        <div class="mb-3  text-warning">
          <label for="email" class="form-label">Email</label>
          <input type="email" class="form-control" name="e-mail" id="" placeholder="Digite seu e-mail">
        </div>
        <div class="mb-3  text-warning">
          <label for="password" class="form-label">Password</label>
          <input type="password" class="form-control" name="senha" id="" placeholder="Digite sua senha">
        </div>
        <div class="mb-3  text-warning">
          <label for="modelodoveículo" class="form-label">Modelo do veículo (para quem pretende oferecer carona)</label>
          <input type="text" class="form-control" name="modelodoveículo" id="" placeholder="Digite o modelo do veículo">
        </div>
        <div class="mb-3  text-warning">
          <label for="placa" class="form-label">Placa</label>
          <input type="text" class="form-control" name="placa" id="" placeholder="Digite sua placa">
        </div>
        <div class="mb-3  text-warning">
