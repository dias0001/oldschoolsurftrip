...
<head>
    ...
    <link rel="stylesheet" href="/css/caronas.css">
...
<body>
    <header>
        ...
        <div class="d-flex justify-content-between px-5 py-2 ">
            ...
            <a class="nav-link text-warning" href="{{ route('caronas')}}">Oferecer carona</a>
        </div>
        </div>
    ...
    <main>
    <h1 class="text-warning text-center">Para onde você quer ir?</h1>
