    ...
    <main>
        ...
        <div id="main-container">
            ...
            <div id="form-container">
                <div id="form-box" class="d-flex justify-content-center flex-row mb-3">
                    <!-- form login -->
                    <form action="" id="login-form">
                        <input type="text" name="name" placeholder="Saindo de...">
                        <input type="text" name="name" placeholder="Indo para......">
                        <input type="number" name="data" placeholder="Hoje">
                        <input type="number" name="number" placeholder="??????">
                        <!-- a duvida é coloar um input ? -->
                        <a class="btn btn-outline-warning" type="button" href="viagem.html">
                            procurar
                        </a>
                    </form>
                </div>
